...
The Android app does not request the `INTERNET` permission. Document, book and vault content stays on-device unless the user explicitly exports or shares something through Android.
